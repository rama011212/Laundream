...
class TambahKasPage extends StatefulWidget {
  @override
  _TambahKasPageState createState() => _TambahKasPageState();
}

class _TambahKasPageState extends State<TambahKasPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Penambahan Kas', style: TextStyle(color: Colors.white),),
  ...
  void _simpanDataKas() {
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Data kas berhasil ditambahkan')),
      );
